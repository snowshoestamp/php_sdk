...
$app_key = $this->app_key;//put your app key here
$app_secret = $this->app_secret; // put your app secret here


$oauth = new OAuthSimple();
$result = $oauth->sign(Array(path => "https://beta.snowshoestamp.com/api/v2/stamp",
                             parameters => $data,
                             action => "POST",
